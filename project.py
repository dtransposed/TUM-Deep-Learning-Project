...
imageDir = 'F:/Wszystko Python/Pytorch Project/Dataset/all data' #directory to one folder where all training images are
imageDir1 = 'F:/Wszystko Python/Pytorch Project/Dataset/all data' #directory to one folder where all validation images are
data_dir = 'F:/Wszystko Python/Pytorch Project/Dataset'#this is actual directory of our dataset
